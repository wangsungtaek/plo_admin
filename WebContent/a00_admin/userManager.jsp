...
<body>
						...
						<div class="card-body pb-0">
							...
							<div class="row mb-1">
								...
								<div class="delBtn col-sm-12 col-md-3 col-lg-2 text-right">
									<button type="button" class="btn btn-danger">일괄 삭제</button>
								</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body wd-70">
					<table class="table table-bordered mb-0" width="100%" cellspacing="0">
						<tr><th>번호</th><td>1</td></tr>
						<tr><th>아이디</th><td>gun5032</td></tr>
						<tr><th>비밀번호</th><td class="text-left"><input id="pass" type="text"/></td></tr>
						<tr><th>이름</th><td>1</td></tr>
						<tr><th>메일</th><td>1</td></tr>
	...
	<script>
		...
		function detail(u_no){
			xhr.open("get", "${path}/a00_admin/z01_userDetail.jsp?no="+u_no, true);
