...
INSERT INTO P_ARTIST VALUES(P_ARTIST_NO_SEQ.NEXTVAL, 'test', '여성', '그룹', '/img/artist/블랙핑크.png');
...
CREATE TABLE P_MUSIC ( 
	...
	m_alb_no NUMBER CONSTRAINT m_alb_no_fk REFERENCES P_ALBUM(alb_no) ON DELETE CASCADE
);
